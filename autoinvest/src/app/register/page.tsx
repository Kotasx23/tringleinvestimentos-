  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-md space-y-4">
        ...
        <input className="w-full border rounded p-2" placeholder="Nome" value={name} onChange={e => setName(e.target.value)} />
        ...
        <p className="text-sm">Já tem conta? <a className="underline" href="/login">Entrar</a></p>
      </form>
    </div>
  );
}